  ...
  const renderJudgeCard = ({ item }) => (
    ...
    >
      ...
      <TouchableOpacity 
        ...
        onPress={(e) => {
          e.stopPropagation();
          navigation.navigate("JudgeDetails", { judge: item });
        }}
      >
        <Text style={styles.assignButtonText}>Assign Event</Text>
      ...
      {selectedJudge ? (
        <ScrollView contentContainerStyle={styles.detailsContainer}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate("JudgeDetails", { judge: selectedJudge })}
          >
            <Text style={styles.fullWidthButtonText}>Assign to Event</Text>
          </TouchableOpacity>
        </ScrollView>
      ) : (
        <>
